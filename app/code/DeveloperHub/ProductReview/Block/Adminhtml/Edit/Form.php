...
namespace DeveloperHub\ProductReview\Block\Adminhtml\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('productimage', '\DeveloperHub\ProductReview\Block\Adminhtml\Post\Renderer\Image');
        $fieldset->addField(
            'file_upload',
            'productimage',
            ['label' => __('Review Media'), 'required' => true, 'name' => 'title' , 'title' => 'Review Media', ]
        );
